...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.quote_text = self.canvas.create_text(150, 100, text="Some Question Text", fill=THEME_COLOR,
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.quote_text, text='You\'ve reached the end of quiz.')
